...
<header class="header">
	<a href="/" class="logo">
		<svg class="logo-svg" xmlns="http://www.w3.org/2000/svg" width="230" height="260" viewBox="0 0 230 260" focusable="no" aria-hidden="true">
		...
		<span class="accessible-svg">Back to Home</span>
	</a>
	<nav class="main-nav">
		<a href="/#work">Work</a>
		<a href="/#about">About</a>
		<a href="mailto:mail@ryanspilhaus.com" target="_blank">Contact</a>
	</nav>
</header><!-- end .header -->
